...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        # Inicializando score do player 1 e 2
        ...
        # tempo para spawnar inimigos e passar o tempo a cada segundo
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                # escolhe aleatoriamente qual inimgo spawnar
                if event.type == EVENT_ENEMY:
                    choice = random.choice(('Enemy1', 'Enemy2'))
                    self.entity_list.append(EntityFactory.get_entity(choice))

                if event.type == EVENT_TIMEOUT:  # reduz o tempo da fase a cada 1 segundo
                    ...
                    if self.timeout == 0:
                        ...
                        return True  # retorna True para terminar o laço while e assim continuar o código no "Game.py" para ir ao próximo level
