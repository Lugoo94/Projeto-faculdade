...
class Score:
    def __init__(self, window: Surface):
        ...
        self.surf = pygame.image.load('./asset/ScoreBg.png').convert_alpha()  # "surf" é o nome criado para a variável / convert_alpha otimiza os píxeis transparentes da imagem
